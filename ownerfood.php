...
<div class="main-content">
   <!-- <img src="images/restaurant/<?php echo $image;?>" class="img-responsive" height = "1000px"> -->
    <div class="wrapper" style="margin-top:50px;">
        <h1 class="text-center" style="margin-bottom:20px; font-style:italic; color:teal;"><?php echo $com_name;?></h1>
       <h1>Manage Your Service details</h1>
    <div class="button">
       <a href="ownerfood_add.php" class="btn-primary">Add Service</a>
       </div>
       ...
       <table class="tbl-full">
           ...
           <?php
             ...
             $sql="SELECT * FROM tbl_service WHERE username='$username'";
           ...
           <tr>
               ...
               <td data-label="Food"><?php echo $service_name;?></td>
